...
<div class="container">
	<div class="row">
             <div class="panel panel-default">
                <div class="panel-heading"><center><font color="black" size="6%">Create Pegawai</font></div>
</center>
                <hr>
               <form class="form-horizontal" role="form" method="POST" action="{{url('/Pegawai')}}" enctype="multipart/form-data">
                ...
                <div class="form-group{{ $errors->has('Nip') ? ' has-error' : '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                               <input type="text" class="form-control" name="permission" value="Pegawai" readonly="">
